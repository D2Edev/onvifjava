...
@XmlType(name = "MotionExpressionConfiguration", propOrder = { "motionExpression", "any" })
public class MotionExpressionConfiguration {
	...
	/**
	 * Ruft den Wert der motionExpression-Eigenschaft ab.
	 * 
	 * @return possible object is {@link MotionExpression }
	 * 
	 */
